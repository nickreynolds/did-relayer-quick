## API Report File for "did-provider-quick"
...
//
// build/peer-did-provider.d.ts:22:9 - (ae-forgotten-export) The symbol "CreatePeerDidOptions" needs to be exported by the entry point index.d.ts
